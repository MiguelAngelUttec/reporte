...
<body>
    ...
    <div class="antialiased sans-serif bg-gray-200 h-screen">
        ...
        <div class="container mx-auto py-6 px-4" x-data="datatables()" x-cloak>
            <h1 class="text-3xl py-4 border-b">Escuelas registradas</h1>
                    ...
                    <div class="shadow rounded-lg flex">
                        <div class="relative">
                            <button @click.prevent="open = !open" class="rounded-lg inline-flex items-center bg-white hover:text-blue-500 focus:outline-none focus:shadow-outline text-gray-500 font-semibold py-2 px-2 md:px-4">
                                ...
                                <span class="hidden md:block">Mostrar</span>
                        ...
                        <template x-for="user in users" :key="user.userId">
                            <tr>
                                ...
                                <td class="border-dashed border-t border-gray-200 phoneNumber">
                                    <span class="text-green-700 px-6 py-3 flex items-center" x-text="user.acciones"></span>
                                </td>
                            </tr>
                        </template>
                    </tbody>
        ...
        <script>
            function datatables() {
                return {
                    ...
                    users: [{
                        "userId": 1,
                        "firstName": "Gabriela Mistral",
                        "lastName": "Primaria",
                        "emailAddress": "ctosh0@github.com",
                        "phoneNumber": "5513131778",
                        "acciones": "editar"
                    }, {
                        "userId": 2,
                        "firstName": "Juan Rulfo",
                        "lastName": "Secundaria",
                        "emailAddress": "bdzeniskevich1@hostgator.com",
                        "phoneNumber": "5572839465",
                        "acciones": "editar"
                    }, {
                        "userId": 3,
                        "firstName": "Nicolas Bravo",
                        "lastName": "Secundaria",
                        ...
                        "userId": 4,
                        "firstName": "Gustavo Baz",
                        "lastName": "Secundaria",
                        "emailAddress": "jklosges3@amazon.de",
                        "phoneNumber": "502-438-799",
                        "acciones": "editar"
                    }, {
                        "userId": 5,
                        "firstName": "Cobaem 35",
                        "lastName": "Media superior",
                        "emailAddress": "fdiclaudio4@phoca.cz",
                        "phoneNumber": "2654489627",
                        "acciones": "editar"
                    }, {
                        "userId": 6,
                        "firstName": "Oficial 233",
                        "lastName": "Media superior",
                        "emailAddress": "omairs5@fda.gov",
                        "phoneNumber": "2215162295",
                        "acciones": "editar"
                    }, {
                        "userId": 7,
                        "firstName": "CBT 4",
